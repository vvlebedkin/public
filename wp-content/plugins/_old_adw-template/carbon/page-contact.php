...
add_action( 'carbon_fields_register_fields', 'crb_attach_theme_contact', 1 );

function crb_attach_theme_contact() {

	Container::make( 'post_meta', __( 'Настройки страницы контакты' ) )
		->where( 'post_type', '=', 'page' )
		->where( 'post_template', '=', 'page-contact.php' )
		->add_tab( __( 'Основные' ), array(
			Field::make( 'text', 'crb_contacts_title', 'Заголовок' ),
			Field::make( 'text', 'crb_contacts_subtitle', 'Подзаголовок' ),
			Field::make( 'textarea', 'crb_contacts_address', 'Адрес' ),
			Field::make( 'text', 'crb_contacts_map', 'Ссылка на карту' ),
			Field::make( 'text', 'crb_contacts_time', 'Время работы' ),
			Field::make( 'complex', 'crb_contacts_shedule', __( 'Расписание' ) )
		    ->add_fields( array(
			...
			Field::make( 'complex', 'crb_contacts_tel', __( 'Телефоны' ) )
		    ->add_fields( array(
					Field::make( 'text', 'title', 'Заголовок' )
							->set_width( 50 ),	
					Field::make( 'text', 'text', 'Текст' )
			...
			Field::make( 'complex', 'crb_contacts_email', __( 'E-mail' ) )
		    ->add_fields( array(
					Field::make( 'text', 'title', 'Заголовок' )
							->set_width( 50 ),	
					Field::make( 'text', 'text', 'Текст' )
		...
		->add_tab( __( 'Первый экран' ), array(
			Field::make( 'text', 'crb_contacts_hero', 'Заголовок блока' ),
			Field::make( 'checkbox', 'crb_contacts_hero_heck', __( 'Отображать блок' ) )
