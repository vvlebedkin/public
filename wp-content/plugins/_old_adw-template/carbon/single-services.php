...
add_action( 'carbon_fields_register_fields', 'crb_attach_theme_services', 1 );

function crb_attach_theme_services() {
	...
	Container::make( 'post_meta', __( 'Настройки страницы о нас' ) )
		...
		->add_tab( __( 'Основные' ), array(
			...
			Field::make( 'text', 'crb_services_subtitle', 'Подзаголовок' ),
		))
		->add_tab( __( 'Первый экран' ), array(
			Field::make( 'text', 'crb_services_hero', 'Заголовок блока' ),
			Field::make( 'checkbox', 'crb_services_hero_heck', __( 'Отображать блок' ) )
