...
add_action( 'carbon_fields_register_fields', 'crb_attach_theme_uslugi', 1 );

function crb_attach_theme_uslugi() {

	Container::make( 'post_meta', __( 'Настройки страницы услуги' ) )
		->where( 'post_type', '=', 'page' )
		->where( 'post_template', '=', 'page-uslugi.php' )
		->add_tab( __( 'Основные' ), array(
			Field::make( 'text', 'crb_uslugi_title', 'Заголовок' ),
			Field::make( 'text', 'crb_uslugi_subtitle', 'Подзаголовок' ),
		))
		->add_tab( __( 'Первый экран' ), array(
			Field::make( 'text', 'crb_uslugi_hero', 'Заголовок блока' ),
			Field::make( 'checkbox', 'crb_uslugi_hero_heck', __( 'Отображать блок' ) )
